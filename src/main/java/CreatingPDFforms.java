...
public class CreatingPDFforms {
    public static final String DEST = "GeneratedPDFs/job_application_PDF_form.pdf";

    public static void main(String args[]) throws IOException {
        File file = new File(DEST);
        file.getParentFile().mkdirs();
        new CreatingPDFforms().createPdf(DEST);
    }
    ...
    public void createPdf(String dest) throws IOException {
        ...
        CreatingPDFforms.addAcroForm(document);
