...
public class UsingTheLowLevelAPI {
    public static final String DEST = "GeneratedPDFs/drawing_with_low_level_api.pdf";

    public static void main(String args[]) throws IOException {
        File file = new File(DEST);
        file.getParentFile().mkdirs();
        new UsingTheLowLevelAPI().createPdf(DEST);
    }
    ...
    public void createPdf(String dest) throws IOException {
        ...
        UsingTheLowLevelAPI.drawAxes(canvas, ps);
